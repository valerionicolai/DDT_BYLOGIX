...
// 1. Test session set
echo "1. Setting session value...\n";
$response1 = makeRequest($baseUrl . '/debug-session', null, $cookieJar);
...
// 2. Test session get (same session)
echo "2. Getting session value (same session)...\n";
$response2 = makeRequest($baseUrl . '/debug-session', null, $cookieJar);
